...
public class DBService {
    ...
    public void instantiateDataBase() throws ParseException{
        ...
        Cliente cli1 = new Cliente(null,"Maria Silva","vlemos@gmail.com","08928194725",TipoCliente.PESSOAFISICA,pe.encode("123")  );
        cli1.getTelefones().addAll(Arrays.asList("219796320158","21987378789"));
        
        Cliente cli2 = new Cliente(null,"Vinicius Lemos","vinicius@versattil.com.br","13437957376",TipoCliente.PESSOAFISICA,pe.encode("123")  );
        cli2.addPerfil(Perfil.ADMIN);
        cli2.getTelefones().addAll(Arrays.asList("219796320158","21987378789"));
        
        
        
        Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
        Endereco e3 = new Endereco(null, "Rua dos Professores", "SN", "QD 467 Lt 14", "Marica", "24933415", cli2, c2);
        ...
        Pagamento pagto2 = new PagamentoComBoleto(null,EstadoPagamento.PENDNETE, ped2,sdf.parse("20/10/2017 00:00"),null);
